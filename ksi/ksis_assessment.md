...
| KSI-MLA-08 | Monitoring, Logging, and Analysis | Pass | Use a least-privileged, role and attribute-based, and just-in-time access authorization model for access to log data. |
